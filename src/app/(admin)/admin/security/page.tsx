...
const mockLogs: ActivityLog[] = [
  ...
  { id: "log-002", timestamp: "2026-02-07T10:30:00Z", userName: "Unknown", userEmail: "admin@polariscloud.ai", event: "suspicious", description: "5 failed login attempts for admin account from unknown IP", ipAddress: "185.220.101.34", subject: "Auth", suspicious: true },
  ...
  { id: "log-006", timestamp: "2026-02-07T09:00:00Z", userName: "Oluwaseun Bakare", userEmail: "seun@polariscloud.ai", event: "role_change", description: "Changed user Kofi Boateng role from user to verifier", ipAddress: "102.89.23.100", subject: "User usr-014", suspicious: false },
  ...
  { id: "log-009", timestamp: "2026-02-07T08:00:00Z", userName: "Aisha Bello", userEmail: "aisha@polariscloud.ai", event: "settings_change", description: "Updated platform pricing for RTX 4090 tier", ipAddress: "102.89.23.101", subject: "Settings/Pricing", suspicious: false },
  ...
  { id: "log-016", timestamp: "2026-02-06T12:00:00Z", userName: "Oluwaseun Bakare", userEmail: "seun@polariscloud.ai", event: "settings_change", description: "Enabled two-factor authentication requirement for admins", ipAddress: "102.89.23.100", subject: "Settings/Security", suspicious: false },
