...
const initialTemplates: Template[] = [
  ...
  { id: "tpl-003", name: "Ubuntu 22.04", description: "Clean Ubuntu 22.04 LTS with build essentials, Python 3.11, and SSH access.", category: "Base OS", image: "ubuntu:22.04-gatehouse", ports: "22, 8080", gpuRequired: false, minGpuMemory: 0, active: true },
  ...
  { id: "tpl-006", name: "ComfyUI", description: "ComfyUI node-based stable diffusion interface with model manager and custom nodes.", category: "AI Art", image: "gatehouse/comfyui:latest", ports: "8188", gpuRequired: true, minGpuMemory: 12, active: true },
  { id: "tpl-007", name: "Stable Diffusion WebUI", description: "Automatic1111 Stable Diffusion WebUI with SDXL support and common extensions.", category: "AI Art", image: "gatehouse/sd-webui:latest", ports: "7860", gpuRequired: true, minGpuMemory: 12, active: true },
