...
const MOCK_DATABASES: Record<string, DatabaseInstance> = {
  "db-prod-001": {
    ...
    status: "running",
    connections: 156,
    connectionString: "postgresql://admin:s3cur3P@ss@db-prod.lagos.gatehouse.cloud:5432/prod-db",
  ...
  "db-cache-002": {
    ...
    status: "running",
    connections: 89,
    connectionString: "redis://default:r3d1sP@ss@db-cache.lagos.gatehouse.cloud:6379",
  ...
  "db-analytics-003": {
    ...
    status: "running",
    connections: 45,
    connectionString: "postgresql://admin:An@lyt1cs@db-analytics.nairobi.gatehouse.cloud:5432/analytics-db",
  ...
  "db-staging-004": {
    ...
    status: "stopped",
    connections: 0,
    connectionString: "mongodb://admin:M0ng0Stg@db-staging.capetown.gatehouse.cloud:27017/staging-mongo",
