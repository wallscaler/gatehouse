...
const MOCK_INSTANCES: Record<string, InstanceDetail> = {
  "inst-a1b2c3d4": {
    ...
    status: "running",
    host: "nairobi-01.gatehouse.cloud",
    port: 22022,
    username: "root",
    password: "gH$9xK2mP!vR4wQ",
    sshCommand: "ssh root@nairobi-01.gatehouse.cloud -p 22022",
    jupyterUrl: "https://nairobi-01.gatehouse.cloud:8888",
    jupyterToken: "a3f8b2c1d4e5f6a7b8c9d0e1f2a3b4c5",
    accessUrls: [
      { label: "Jupyter Lab", url: "https://nairobi-01.gatehouse.cloud:8888" },
      { label: "TensorBoard", url: "https://nairobi-01.gatehouse.cloud:6006" },
    ],
    uptime: "4h 23m",
    duration: "12 Hours",
    costSoFar: 3.72,
  ...
  "inst-e5f6g7h8": {
    ...
    status: "running",
    host: "lagos-02.gatehouse.cloud",
    port: 22022,
    username: "root",
    password: "kL$7nM3jR!wT9xB",
    sshCommand: "ssh root@lagos-02.gatehouse.cloud -p 22022",
    accessUrls: [],
    uptime: "12h 07m",
    duration: "1 Day",
    costSoFar: 3.02,
  ...
  "inst-q7r8s9t0": {
    ...
    region: "London, UK",
    status: "terminated",
    host: "london-01.gatehouse.cloud",
    port: 22022,
    username: "root",
    password: "tR$2pQ8vN!xM5kJ",
    sshCommand: "ssh root@london-01.gatehouse.cloud -p 22022",
    accessUrls: [],
    uptime: "23h 58m",
    duration: "1 Day",
    costSoFar: 107.82,
