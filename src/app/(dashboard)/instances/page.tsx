...
const MOCK_INSTANCES: Instance[] = [
  ...
  },
  {
    ...
    region: "Lagos, Nigeria",
    status: "pending",
    sshCommand: "ssh root@lagos-01.gatehouse.cloud -p 22022",
    uptime: "0m",
  ...
  },
  {
    ...
    status: "stopped",
    sshCommand: "ssh root@capetown-01.gatehouse.cloud -p 22022",
    jupyterUrl: "https://capetown-01.gatehouse.cloud:8888",
    uptime: "8h 45m",
  ...
  },
  {
    ...
    status: "terminated",
    sshCommand: "ssh root@amsterdam-01.gatehouse.cloud -p 22022",
    uptime: "5h 12m",
