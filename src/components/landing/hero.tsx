    ...
    <section className="relative overflow-hidden bg-soft-sage">
      <div className="mx-auto max-w-6xl px-6 py-24 md:py-32">
        <div className="flex flex-col items-center text-center">
          <div className="mb-6 flex items-center gap-2 rounded-full border border-border bg-white px-4 py-2 text-sm text-muted-foreground shadow-sm">
          ...
          <div className="mt-16 w-full max-w-4xl rounded-xl border border-border bg-white p-4 shadow-lg">
